          ...
          <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
            ...
            <form method="POST" class="needs-validation" novalidate>
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-8 col-lg-9">
                  <input name="edit_first_name" type="text" class="form-control"
                    value="<?= $patient[0]->user_first_name ?>" required>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-8 col-lg-9">
                  <input name="edit_last_name" type="text" class="form-control" value="<?= $patient[0]->user_last_name ?>"
                    required>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-8 col-lg-9">
                  <input name="edit_email" type="email" class="form-control" value="<?= $patient[0]->user_email ?>"
                    required>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-8 col-lg-9">
                  <input name="edit_username" type="text" class="form-control" value="<?= $patient[0]->user_name ?>"
                    required>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-8 col-lg-9">
                  <input name="edit_phone" type="text" class="form-control" value="<?= $patient[0]->user_number ?>"
                    required>
                </div>
              </div>
              ...
              <div class="text-center">
                <button type="submit" class="btn btn-primary" name="edit-patient">Save Changes</button>
              </div>
            </form>
