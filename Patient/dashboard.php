                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <?php if($a->appointment_status == 'Pending'): ?>
                          <form method="POST">
                            <input type="hidden" name="appointment_id" value="<?= $a->appointment_id ?>">
                            <button type="submit" class="btn btn-danger btn-sm" name="cancel_appointment" title="Cancel Appointment" onclick="return confirm('Are you sure you want to cancel this appointment?');">
