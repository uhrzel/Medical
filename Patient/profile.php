...
if(isset($_POST['change-password-patient'])){

    if(password_verify(Input::get('current_password'), $patient[0]->user_password)){
                    ...
                    <div class="tab-content pt-2">
                            ...
                            <form method="POST" class="needs-validation" novalidate>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <input name="edit_first_name" type="text" class="form-control" value="<?= $patient[0]->user_first_name ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <input name="edit_last_name" type="text" class="form-control" value="<?= $patient[0]->user_last_name ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <input name="edit_email" type="email" class="form-control" value="<?= $patient[0]->user_email ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <input name="edit_username" type="text" class="form-control" value="<?= $patient[0]->user_name ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <input name="edit_phone" type="text" class="form-control" value="<?= $patient[0]->user_number ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <select name="edit_gender" class="form-select form-control">
                                            <option selected hidden value="<?= $patient[0]->user_gender ?>">Select</option>
                                        <?php 
                                            $gender = ['Male', 'Female'];
                        ...
                        <div class="tab-pane fade pt-3" id="profile-change-password">
                            ...
                            <form method="POST" class="needs-validation h-100 my-5" novalidate>
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary" name="change-password-patient">Change Password</button>
                                </div>
