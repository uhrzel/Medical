                            ...
                            <!-- <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8">
                                    ...
                                    <div class="input-group mb-3">
                                        <input  id="profile-password" value="<?= $doctor[0]->user_password ?>" type="password" class="form-control" aria-describedby="button-addon2" disabled>
                            ...
                            <form method="POST" class="needs-validation" novalidate>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <input name="edit_first_name" type="text" class="form-control" value="<?= $doctor[0]->user_first_name ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <input name="edit_last_name" type="text" class="form-control" value="<?= $doctor[0]->user_last_name ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <input name="edit_email" type="email" class="form-control" value="<?= $doctor[0]->user_email ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <input name="edit_username" type="text" class="form-control" value="<?= $doctor[0]->user_name ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <input name="edit_phone" type="text" class="form-control" value="<?= $doctor[0]->user_number ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <select name="edit_gender" class="form-select form-control">
                                            <option selected hidden value="<?= $doctor[0]->user_gender ?>">Select</option>
                                        <?php 
                                            $gender = ['Male', 'Female'];
